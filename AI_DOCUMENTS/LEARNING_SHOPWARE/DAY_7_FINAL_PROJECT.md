...
Now, create the entity definition for product recommendations:

File: custom/plugins/LearningBundle/src/Core/Content/Recommendation/ProductRecommendationDefinition.php

**ProductRecommendationDefinition.php:**
```php
<?php declare(strict_types=1);
